...
router.post('/login', async (req, res) => {
    ...
    if (!validPass) return res.status(400).send('Error: Incorrect email or password!')

    //Create and assigh token - jwt 
    const token = jwt.sign({ ID: user._id }, process.env.TOKEN_SEC)
